...
Custom Character Model: We downloaded a custom rigged character  and integrated it into the project. The model is scaled down from centimeter to meter units via the mWorld matrix. Press 8 to load the character. It can be posed using the same bone rotation and selection controls as the built-in models.
